...
export const entries = {
  entry5: {
    ...
    description: (
      <div>
        This group of musicians from Marseillan, boasts a broad repertoire from
        the good oldies to contemporary music. Let them take you to that “late
        night jazz club” feeling with their pleasant swing, bluesy and jazzy
        tunes! With their charm and sharp wit, vocalist Gabrielle (on double
        bass), and Christine on drums offer you their classics: each piece is a
        story told together with Jeff, their creative guitarist.
        <br />
        <br />
  ...
  entry7: {
    ...
    description: (
      <div>
        ...
        gospel, and has been a lecturer at Malmö Academy of Music since 1985.
        Singer, actor, composer, lyricist, this multi-talent has appeared on
        jazz festivals, in TV and radio both in her native Sweden and abroad.
        Her album "Reflections Of A Voice" was released to much acclaim and won
        second runner-up in the Women's Vocal Section of "The 40th Annual Jazz
        Station Awards - The Best Jazz 2018".
        <br />
        <br />
        Elisabeth often features as a guest soloist for ensembles, big bands and
        choirs, and for Musiques en Thau she will be accompanied by the Cédric
        Chauveau (to the left) with his Cédric Chauveau Trio.
      </div>
    ),
  },
  ...
  entry9: {
    ...
    description: (
      <div>
        ...
        over the years. Today it consists of founding member Svein Aarbostad
        (double bass), violinist/harmonicist Finn Hauge, French guitarist Gildas
        Le Pape and newcomer Ola Erlien. With members aged 22 to 72, the group
        brilliantly demonstrates that jazz defies all borders!
      </div>
    ),
  },
};
...
entry: {
    key: "entry",
    title: "Sponsors",
    image: "/images/musiques_sponsors_poster.jpg",
    description: "",
  },
  */
